...
final class ApiAuthenticationTest extends WebTestCase
{
    ...
    public function testApiAuthenticationUpdatesLastUsedAt(): void
    {
        ...
        $this->assertNotInstanceOf(\DateTimeImmutable::class, $apiToken->getLastUsedAt());
        ...
        $this->assertInstanceOf(\App\Entity\ApiToken::class, $updatedToken);

        $this->assertInstanceOf(\DateTimeImmutable::class, $updatedToken->getLastUsedAt());
